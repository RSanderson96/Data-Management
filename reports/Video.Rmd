...
```{R_Question_Lines, echo = FALSE}
Q9 = L8 + geom_vline(xintercept = (S[1]), (aes (colour = "red")))
Q10 = L9 + geom_vline(xintercept = (S[2]), (aes (colour = "red")))
Q11 = L10 + geom_vline(xintercept = (S[3]), (aes (color = "red")))
Q12 = L11 + geom_vline(xintercept = (S[4]), (aes (color = "red")))
Q13 = L12 + geom_vline(xintercept = (S[5]), (aes (color = "red")))
Q13
...
To do a hypothesis tests, the overall percentage of correct quiz responses for each learner was calculated;
...
This assessment is undertaken through a two tailed test:
Ho: 
